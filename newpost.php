...
#	mysqli_query($link,$query);
    ...
    if ($_POST['postOnline']=="PostOnline"){
        $query="INSERT INTO `posters` (`id`,`gpsx`, `gpsy`,`subject`,`descrition`,`category`,`reward`,`assginTo`)VALUES ('".$_COOKIE['id']."','".$_POST['gpsx']."', '".$_POST['gpsy']."','".$_POST['subject']."','".$_POST['descrition']."','".$_POST['category']."','".$_POST['reward']."','".$_POST['assginTo']."')";
        mysqli_query($link,$query);
...
<form method="post">
	...
	<textarea type="text" placeholder="subject" pattern="{200}"name="subject"><?php echo $_POST['subject']?></textarea>
	<div>starttime</div>
    <div>
	...
	<textarea type="text" placeholder="description" name="descrition"><?php echo $_POST['descrition']?></textarea>
	<input type="float" placeholder="gpsx" name="gpsx" value=<?php echo $_POST['gpsx']?> >

	<input type="float" placeholder="gpsy" name="gpsy" value=<?php echo $_POST['gpsy']?> >
    ...
    <input type="text" placeholder="assgin to" name="assginTo" value=<?php echo $_POST['assginTo']?> >
	<input type="submit" name="postOnline" value="PostOnline"/>
